...
SEGMENT_GUIDELINES = {
    ...
    "SEG04": {  # 고수 단순
        ...
        "risk_guidance": "핵심 리스크 지표 3~5개를 선별하여 해석과 함께 제시. 단순 수치 나열이 아니라 '이 수치가 의미하는 것'을 한 문장으로 해석.",
        "recommendation_style": "고객의 실제 상황에 기반한 구체적 액션 아이템 3개 제시. '현재 ~이므로 ~하세요' 형태.",
        "structure": "결론(핸심 진단 1문장) → 주요 리스크 요인 설명(2~3문장) → 구체적 액션 아이템(3개)",
        "avoid": "비유, '마치', '처럼', 감성적 표현, '안심', '걱정', 긴 배경 설명, 물음표로 끝나는 제안, raw 데이터 값 그대로 나열",
    },
}
